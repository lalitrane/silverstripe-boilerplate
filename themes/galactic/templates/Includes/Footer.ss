            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <a href="$BaseHref" class="brand">
                        ...
                        <img src="$SiteConfig.Logo_Dark.URL" title="$SiteConfig.Logo_Dark.Title"
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <ul class="footernav">
                                ...
                                <li class="$FirstLast $LinkingMode"><a href="$Link"
                                        title="Go to the $Title.XML page"><span>$MenuTitle.XML</span></a></li>
                                <% end_loop %>
                            </ul>
                        </div>
                        <div class="col-lg-6">
